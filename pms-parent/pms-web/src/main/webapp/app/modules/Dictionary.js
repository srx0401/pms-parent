Ext.define('App.modules.Dictionary', {  
    	...
    	if(!moduleWin){
	    	...
	    	var ModuleObject = function(){
	    		this.api = {
	                        ...
	                        typeList    : __ctxPath + MODULE_CODE + '/typeList.do'
	    		};
	    		this.help = function(){
	    			Ext.MessageBox.show({
                        title: '使用说明',
	        ...
	        Ext.define('Srx.model.' + this.id, {  
	            extend:'Ext.data.Model',  
	            fields:[
					{name:'id'},{name:'code'},{name:'name'},{name:'type'},{name:'module'},
	        ...
	        var typeStore = Ext.create('Ext.data.Store', { 
	    		...
	    		listeners:{
					beforeload:{
						fn:function(s,o,e) {
							Ext.apply(s.proxy.extraParams, {"parentCode":"dictionaryType"}); 
						}
					}
		        }
	        });
                ...
                items: [new Ext.form.FieldSet({
            		...
            		items : [ {
            			...
            			items:[
							   ...
							   {items : [ {
									...
									listeners:{
										change:{
											fn:function(t,n,o,e){
												if(n == 7){
													Ext.getCmp("module").disable();
												}else{
													Ext.getCmp("module").enable();
												}
												return n;
											}
										}
        			    	   ...
        			    	   {items:[{name:'module',id:"module",xtype:'textfield',fieldLabel:'ExtDefine',beforeLabelTextTpl:required,
            			    	   allowBlank:false,maxLength:50}]},
